...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "b6f4ceaed0a0a24ccf575fab6c56dd50ccf6f1a9"
  WORKING_DIRECTORY "D:/service/project/dna-scontig/thirdparty/fmt-8.1.1/src/fmt-8.1.1"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/service/project/dna-scontig/thirdparty/fmt-8.1.1/src/fmt-8.1.1'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/service/project/dna-scontig/thirdparty/fmt-8.1.1/src/fmt-8.1.1'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
